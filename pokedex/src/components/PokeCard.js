...
export default function PokeList({ pokemon }) {
  return (
    <div className="w-[80%] xl:max-w-sm flex flex-col m-auto items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <img
      ...
      <div className="min-w-full">
        ...
        <div className="">
          ...
          {/* <p class="mb-3 ml-5 font-normal text-gray-700 dark:text-gray-400 ">
            <span className="text-[1.3rem] font-bold ">Moves:</span>
