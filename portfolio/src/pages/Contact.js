...
export function Contact() {
    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col items-center text-center" id="contact">
                <h1 className="text-white font-Roboto text-[2rem]">Contact Me</h1>
                <p className="text-white font-Roboto text-[1.3rem]">Connect with me via my LinkedIn or submit the form below to get started.</p>
                ...
                <form ref={form} onSubmit={sendEmail} className="items-center  m-auto mt-5 flex flex-col p-3 mb-5 w-[90vw] xl:w-auto h-[60vh] border border-white rounded-lg bg-slate-800">
                    ...
                    <label htmlFor="name" className="text-white  text-[1.3rem] font-Roboto w-[85vw] text-left xl:w-[100%] " >Name:</label>
                    ...
                    <label htmlFor="email" className="text-white text-[1.3rem] w-[85vw] text-left xl:w-[100%]" >Email:</label>
                    ...
                    <label htmlFor="message" className="text-white text-[1.3rem] text-left font-Roboto w-[85vw] xl:w-[100%]">Message:</label>
                    ...
                    <button className="text-[1.5rem] text-white border w-[30%] mt-5 hover:text-slate-800 hover:bg-white">Send</button>
                </form>
