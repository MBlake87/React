...
export function Projects() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col  xl:flex-row xl:m-auto  items-center xl:w-[75%] py-[3rem]"><Link to="/"><img className=" px-3 xl:pr-10 xl:max-w-[40rem] hover:-translate-y-2 hover:scale-110 duration-300 cursor-pointer" src={portfolio} alt="portfolio" /></Link>
            ...
            <div className="flex flex-col xl:flex-row xl:w-[75%] xl:m-auto items-center py-[3rem]"><Link to="https://marks-pokedex-api.netlify.app/"><img className=" px-3 xl:max-w-[40rem] xl:pr-10 hover:-translate-y-2 hover:scale-110 duration-300 cursor-pointer" src={pokedex} alt="pokedex" /></Link>
                <p className="text-[.75rem] pl-3 text-left pt-10 xl:text-[1.5rem] w-[100%] text-white">I loved Pokemon as a child and this API let me relive some memories! My first venture into the world of API's, developed with React, Tailwind and the <a className="underline " href="https://pokeapi.co/">PokeAPI</a></p></div>
        </>
