...
//redux imports for controlling state
import { useDispatch, useSelector } from "react-redux"
//the mode and logout states
    ...
    return <FlexBetween padding="1rem 6%" backgroundColor={alt}>
        ...
        {isNonMobileScreens ? (<FlexBetween gap="2rem"> <IconButton onClick={() => dispatch(setMode())}>
            {theme.palette.mode === "dark" ? (
                ...
                <LightMode sx={{ color: dark, fontSide: "25px" }} />
            )}
        </IconButton>
            ...
            <FormControl varient="standard" value={fullName}>
                <Select value={fullName}
                    sx={{
                        backgroundColor: neutralLight, width: "150px", borderRadius: "0.25rem", p: "0.25rem 1rem",
                        //select specific class from material and change properties
                        "& .MuiSvgIcon-root": {
                            pr: "0.25rem",
                            width: "3rem"
                        },
